...
public class Directorio extends Elemento{
    ...
    public void agregarArbolPapelera(){
        Element directorio = Explorador.arbol2.createElement("directorio");
        Explorador.currentDir2.appendChild(directorio);
        Attr attr = Explorador.arbol2.createAttribute("id");
        attr.setValue(String.valueOf(Explorador.getCurrentId2()));
        Explorador.setCurrentId2(Explorador.getCurrentId() + 1);      
    ...
    public void clonarPapelera(){
        Explorador.currentDir2.appendChild(Explorador.elementoaPegar2.cloneNode(true));
        XMLManager xml = new XMLManager();
